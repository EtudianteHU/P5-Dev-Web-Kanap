...
inputsQuantity.forEach((input) => {
  input.addEventListener('change', (event) => {
    ...
    const id = article.getAttribut
    const totalQuantityPanier = panierObject.find((panier) => panier.id === id)


    console.log("totalQuantityPanier", totalQuantityPanier)
    console.log("newvValue", newValue)
    ...
    const totalPrice = panierObject.find(product.id)
  ...
  deleteLinks.forEach((link) => {
    link.addEventListener('click', (event) => {
      const totalQuantity = panierObject.find(product.id)
      console.log("totalQuantity", totalQuantity)
      console.log("newValue", newValue)
      totalQuantity = Number.newValue


      const priceTotal = panierObject.find(product.id)
      console.log(priceTotal)
      localStorage.removeItem('panier', JSON.stringify(panierObject))
