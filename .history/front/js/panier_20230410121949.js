...
inputsQuantity.forEach((input) => {
  input.addEventListener('change', (event) => {
    const totalQuantity = panierObject.find(product)
    totalQuantityPanier = totalQuantity + panier.quantity
    ...
    const totalPrice = panierObject.find(product)
    console.log("totalPrice", totalPrice)
    console.log("newvValue", newValue)
    localStorage.setItem('panier', JSON.stringify(panierObject))

    totalPrice = totalPrice + panier.quantity
