...
btnSelector.addEventListener('click', (event) => {
    ...
    if (quantityNumber <= 0 || quantityNumber > 100 || quantityNumber != "" && selectedColor === undefined) { // si la qté est inférieure à 0 ou supérieure à 100, on affiche un mesage d'erreur
