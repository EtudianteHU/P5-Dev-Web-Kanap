...
const nomContainer = document.querySelector('.item__img')
console.log(nomContainer)
nomContainer.innerHTML = `<img src="../images/logo.png" alt="Photographie d'un canapé">`
...
descriptionContainer.innerHTML = ` Dis enim malesuada risus sapien gravida nulla nisl arcu`
