...
inputsQuantity.forEach((input) => {
  input.addEventListener('change', (event) => {
    const totalQuantity = panierObject.find((id) => panier.id === id)
    ...
    const totalPrice = panierObject.find((panier.id) => panier.id === id)
...
deleteLinks.forEach((link) => {
  link.addEventListener('click', (event) => {
    ...
    const priceTotal = panierObject.find(panier.id)
