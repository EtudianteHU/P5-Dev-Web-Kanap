...
function makeRequestBody() {
  ...
  const isPrenomInValid = form.elements.firstName.value
  const isNomInValid = form.elements.lastName.value
  const isAdressInValid = form.elements.address.value
  const isCityInValid = form.elements.city.value
  const isEmailInValid = form.elements.email.value
  const body = {
    contact: {
